...
export class EmailConfig {
      ...
      public sendEmail = async (email: any, subject: any, html: any) => {
        try {
            
            await transporter.sendMail({
                from: `PIUTS <${ mail.user }>`, 
                to: email, 
                subject, 
                text: "Pruebas verificacion de email", 
                html, 
            });
      ...
      public getTemplateRegister = (name: any, token: any) => {
          return `
            <head>
            ...
            <div id="email___content">
                ...
                <a
                    href="https://apidev.tools.antpack.co/piuts/api/users/confirm/${ token }"
                    target="_blank"
                >Confirmar Cuenta</a>
            </div>
          `;
      ...
      public getTemplateUpdateEmail = (name: any, token: any) => {
        return `
            <head>
                <link rel="stylesheet" href="./style.css">
            </head>
            ...
            <div id="email___content">
                <h2>Hola ${ name }</h2>
                <p>Para confirmar la actualizacion de tu correo, ingresa al siguiente enlace</p>
                <a
                    href="https://apidev.tools.antpack.co/piuts/api/users/updateEmailConfirm/${ token }"
                    target="_blank"
                >Actualizar Cuenta</a>
            </div>
        `;
      ...
      public getTemplateForgotPassword = (email:any ,code:any) => {
        return `
        ...
        <html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" style="width:100%;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0"> 
         <head> 
          ...
          <title>Nueva plantilla de correo electrC3B3nico 2022-03-28</title><!--[if (mso 16)]>
            <style type="text/css">
                         ...
                         <tr style="border-collapse:collapse"> 
                          <td valign="top" align="center" style="padding:0;Margin:0;width:600px"> 
                           <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;background-color:#ffffff;border-radius:4px" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff" role="presentation"> 
                             <tr style="border-collapse:collapse"> 
                              <td align="center" style="Margin:0;padding-bottom:5px;padding-left:30px;padding-right:30px;padding-top:35px"><h1 style="Margin:0;line-height:58px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:48px;font-style:normal;font-weight:normal;color:#111111">No te preocupes, a todos se nos olvida alguna vez!</h1></td> 
                             </tr> 
                             <tr style="border-collapse:collapse"> 
                         ...
                         <tr style="border-collapse:collapse"> 
                          <td valign="top" align="center" style="padding:0;Margin:0;width:600px"> 
                           <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-radius:4px;background-color:#ffffff" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff" role="presentation"> 
                             ...
                             <tr style="border-collapse:collapse"> 
                              <td class="es-m-txt-l" align="left" style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">Hace poco pediste restablacer la contraseña de la siguiente cuenta:</p></td> 
                             </tr> 
                             <tr style="border-collapse:collapse"> 
                              <td class="es-m-txt-l" align="left" style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px"><div target="_blank" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#3d85c6;font-size:18px">Email: ${email}.</div></td> 
                             </tr> 
                             <tr style="border-collapse:collapse"> 
                              <td class="es-m-txt-l" align="left" style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">Para actualizar tu contraseña, utiliza el siguiente código: <strong> ${code}; </strong></p></td> 
                             </tr> 
                             <tr style="border-collapse:collapse"> 
